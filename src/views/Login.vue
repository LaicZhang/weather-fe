  ...
  <div class="bg" :style="{ backgroundImage: `url(${coverImgUrl ? coverImgUrl : baseImgUrl})`, backgroundSize: 'cover' }">
    <div class="login-page">
      <el-form ref="userFormRef" class="login-form" :model="userForm" :rules="userRules" status-icon>
        ...
        <el-input v-model="userForm.captchaCode" placeholder="请输入验证码"></el-input>
      </el-form-item> -->
        <el-form-item>
          <el-button text size="small" @click="toForget">
            忘记密码？
          </el-button>
          <span>或</span>
          <el-button text size="small" @click="toRegister">
            注册
          </el-button>
          <span>或</span>
          <el-button text size="small" @click="toHomeAsVisitor">
            不想注册？一键游客登陆
          </el-button>
        </el-form-item>
        <el-form-item>
